...
If $\alpha I + (1-\alpha)S_w$ is invertible, we can easily get $W$ using eigenvector-eigenvalue method. Detailed derivation and the pros/cons of this method can be found in \cref{subsec:Q4}.
