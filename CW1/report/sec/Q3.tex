...
Based on this observation, we decided to fix $M_{pca}=150$ and $M_{lda}=50$ for future experiments. Detailed result including confusion matrix and images can be found in \cref{subsec:Q13_cm} and \cref{subsec:Q13_eg}.  % 링크추가하기
