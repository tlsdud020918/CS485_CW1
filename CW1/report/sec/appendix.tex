...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\linewidth]{image/q3_1_cm.png} % Seems better to move to Appendix,,
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\linewidth]{image/q3_2_cm.png} % Seems better to move to Appendix,,
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\linewidth]{image/q3_success.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.4\linewidth]{image/q3_fail.png}
