...
% 
% The script is divided in 4 different sections as follows:
%   
...
% Select dataset among {'Toy_Gaussian', 'Toy_Spiral', 'Toy_Circle'}
...
disp('1: Press any key to continue');
pause; 
%%%%%%%%%%%%%%%%%%%%%%
...
disp('2.1: Press any key to continue');
pause; 
%% 2.2 Growing a tree
...
for n = 1:param.splitNum
    ...
    drawnow;
    disp('2.2.1: Press any key to continue');
    pause; 
end
...
for N = [2,5,7,11] % Tree depth, try {2,5,7,11}
    ...
    % Visualise
    visualise(data_train,p_rf,[],0);
    disp('4.2: Press any key to continue');
    pause;
end